...
,
    ...
    "resume_checkpoint": str(IMPALA_PROJECT_ROOT / "shared_outputs/train/2026-06-16_18-20-20_2P/runs/checkpoint_16168880.pt"),
    ...
    "teacher": {
         "checkpoint" : str(IMPALA_PROJECT_ROOT / "shared_outputs/train/2026-06-16_01-45-38_2P/runs/checkpoint_7618884.pt"), # big
    ...
    "frozen_opponent": {
        ...
        "checkpoints": [
            (2, str(IMPALA_PROJECT_ROOT / "shared_outputs/train/2026-06-10_03-28-36/runs/checkpoint_23246262.pt")), # > 0.85        1
            (2, str(IMPALA_PROJECT_ROOT / "shared_outputs/train/2026-06-10_07-43-44/runs/checkpoint_29085966.pt")), # > 0.55        2 
            (2, str(IMPALA_PROJECT_ROOT / "shared_outputs/train/2026-06-11_07-25-12/runs/checkpoint_45358482.pt")), # > 0.2         3
            (2, str(IMPALA_PROJECT_ROOT / "shared_outputs/train/2026-06-11_08-54-37_2P_TOP/runs/checkpoint_53333670.pt")), # = 0.0  4
            (4, str(IMPALA_PROJECT_ROOT / "shared_outputs/train/2026-06-10_15-27-31/runs/checkpoint_20946510.pt")), # = 1           5 
            (4, str(IMPALA_PROJECT_ROOT / "shared_outputs/train/2026-06-10_21-16-56/runs/checkpoint_31094154.pt")), # = 1           6
            (4, str(IMPALA_PROJECT_ROOT / "shared_outputs/train/2026-06-11_16-55-25/runs/checkpoint_59453394.pt")), # = 1           7
            (4, str(IMPALA_PROJECT_ROOT / "shared_outputs/train/2026-06-13_23-49-40/runs/checkpoint_80988414.pt")), # = 0.5         8 
            str(IMPALA_PROJECT_ROOT / "shared_outputs/train/2026-06-16_01-45-38_2P/runs/checkpoint_7618884.pt"), # = 0              9
    ...
    "num_buffers": 80,
    "num_stats_buffers": 80,
    "num_inference_buffers_train": 80,

    "num_inference_workers_train_cuda0": 4,
    "num_inference_workers_train_cuda1": 0,
