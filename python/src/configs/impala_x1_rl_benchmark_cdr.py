"""
x1 CDR benchmark experiment: overrides on top of :func:`configs.base.default_training_config_dict`.
...
from src.configs.impala_x1_rl_cdr import IMPALA_X1_RL_OVERRIDES
...
def _policy_env_overrides_from_cdr() -> dict:
    return {
        key: IMPALA_X1_RL_OVERRIDES[key]
        for key in _POLICY_ENV_KEYS_FROM_CDR
    }

IMPALA_X1_RL_BENCHMARK_CDR_OVERRIDES: dict = {
    **_policy_env_overrides_from_cdr(),
    "enable_wandb": False,
    "enable_desync": False,
    ...
    "num_benchmark_inference_workers_cuda1": 0,
...
def build_training_config() -> SimpleNamespace:
    merged = deep_merge_dicts(default_training_config_dict(), IMPALA_X1_RL_BENCHMARK_CDR_OVERRIDES)
